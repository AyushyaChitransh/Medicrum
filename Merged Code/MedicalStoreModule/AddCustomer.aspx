<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCustomer.aspx.cs" Inherits="MedicalStoreModule.AddCustomer" %>
                            ...
                            <section>
                                ...
                                <div class="uk-grid">
                                    <div class="uk-width-medium-1-1 parsley-row">
                                        <label for="wizard_customer_name">Customer Name<span class="req">*</span></label>
                                        <input type="text" name="customerName" id="wizard_customer_name" required="required" class="md-input" />
                                    </div>
                                </div>
                                <div class="uk-grid">
                                    <div class="uk-width-medium-1-1 parsley-row">
                                        <label for="wizard_trade_name">Company Name</label>
                                        <input type="text" name="companyName" id="wizard_companyName" class="md-input" />
                                    </div>
                                </div>
                                <div class="uk-grid">
