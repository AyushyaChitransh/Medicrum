...
altair_crud_table = {
    init: function () {
        ...
        $('#product_list').jtable({
            ...
            actions: {
                listAction: '/EmergencyStocks.aspx/ProductEmergencyList',
                updateAction: '/EmergencyStocks.aspx/UpdateProduct',
                deleteAction: '/EmergencyStocks.aspx/DeleteProduct'
            },
            fields: {
                productId: {
                    key: true,
                ...
                productModelId: {
                    title: 'Product Name',
                    width: '20%',
                    options: '/EmergencyStocks.aspx/GetProductModelOptions'
                },
                supplierId: {
                    title: 'Supplier Name',
                    width: '20%',
                    sorting: false,
                    options: '/EmergencyStocks.aspx/GetSupplierOptions'
                },
                barcode: {
                    title: 'Barcode',
                    list: false
